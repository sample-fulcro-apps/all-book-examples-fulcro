...
var fexpr__68947 = (function (p__68948,seen__$1){
while(true){
var vec__68949 = p__68948;
var x = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__68949,(0),null);
var xs__$1 = vec__68949;
var temp__5735__auto__ = cljs.core.seq(xs__$1);
if(temp__5735__auto__){
var s = temp__5735__auto__;
var v = (f.cljs$core$IFn$_invoke$arity$1 ? f.cljs$core$IFn$_invoke$arity$1(x) : f.call(null,x));
if(cljs.core.contains_QMARK_(seen__$1,v)){
var G__69080 = cljs.core.rest(s);
var G__69081 = seen__$1;
p__68948 = G__69080;
seen__$1 = G__69081;
continue;
} else {
...
var caller = orchestra_cljs.spec.test.find_caller((function (){var G__68954 = orchestra_cljs.spec.test.get_host_port();
var G__68955 = (new Error()).stack;
var G__68956 = orchestra_cljs.spec.test.get_env();
var G__68957 = null;
return (cljs.stacktrace.parse_stacktrace.cljs$core$IFn$_invoke$arity$4 ? cljs.stacktrace.parse_stacktrace.cljs$core$IFn$_invoke$arity$4(G__68954,G__68955,G__68956,G__68957) : cljs.stacktrace.parse_stacktrace.call(null,G__68954,G__68955,G__68956,G__68957));
})());
var via = (function (){var temp__5737__auto__ = (function (){var fexpr__68958 = new cljs.core.Var(function(){return cljs.spec.alpha.spec_name;},new cljs.core.Symbol("cljs.spec.alpha","spec-name","cljs.spec.alpha/spec-name",888422400,null),cljs.core.PersistentHashMap.fromArrays([new cljs.core.Keyword(null,"private","private",-558947994),new cljs.core.Keyword(null,"ns","ns",441598760),new cljs.core.Keyword(null,"name","name",1843675177),new cljs.core.Keyword(null,"file","file",-1269645878),new cljs.core.Keyword(null,"end-column","end-column",1425389514),new cljs.core.Keyword(null,"column","column",2078222095),new cljs.core.Keyword(null,"line","line",212345235),new cljs.core.Keyword(null,"end-line","end-line",1837326455),new cljs.core.Keyword(null,"arglists","arglists",1661989754),new cljs.core.Keyword(null,"doc","doc",1913296891),new cljs.core.Keyword(null,"test","test",577538877)],[true,new cljs.core.Symbol(null,"cljs.spec.alpha","cljs.spec.alpha",505122844,null),new cljs.core.Symbol(null,"spec-name","spec-name",-1420007703,null),"cljs/spec/alpha.cljs",17,1,93,93,cljs.core.list(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"spec","spec",1988051928,null)], null)),null,(cljs.core.truth_(cljs.spec.alpha.spec_name)?cljs.spec.alpha.spec_name.cljs$lang$test:null)]));
return (fexpr__68958.cljs$core$IFn$_invoke$arity$1 ? fexpr__68958.cljs$core$IFn$_invoke$arity$1(spec) : fexpr__68958.call(null,spec));
})();
if((temp__5737__auto__ == null)){
return cljs.core.PersistentVector.EMPTY;
} else {
var n = temp__5737__auto__;
...
throw cljs.core.ex_info.cljs$core$IFn$_invoke$arity$2(["Call to ",cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var fexpr__68964 = new cljs.core.Var(function(){return cljs.spec.alpha.__GT_sym;},new cljs.core.Symbol("cljs.spec.alpha","->sym","cljs.spec.alpha/->sym",-2031271081,null),cljs.core.PersistentHashMap.fromArrays([new cljs.core.Keyword(null,"private","private",-558947994),new cljs.core.Keyword(null,"ns","ns",441598760),new cljs.core.Keyword(null,"name","name",1843675177),new cljs.core.Keyword(null,"file","file",-1269645878),new cljs.core.Keyword(null,"end-column","end-column",1425389514),new cljs.core.Keyword(null,"column","column",2078222095),new cljs.core.Keyword(null,"line","line",212345235),new cljs.core.Keyword(null,"end-line","end-line",1837326455),new cljs.core.Keyword(null,"arglists","arglists",1661989754),new cljs.core.Keyword(null,"doc","doc",1913296891),new cljs.core.Keyword(null,"test","test",577538877)],[true,new cljs.core.Symbol(null,"cljs.spec.alpha","cljs.spec.alpha",505122844,null),new cljs.core.Symbol(null,"->sym","->sym",696606926,null),"cljs/spec/alpha.cljs",13,1,323,323,cljs.core.list(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"x","x",-555367584,null)], null)),"Returns a symbol from a symbol or var",(cljs.core.truth_(cljs.spec.alpha.__GT_sym)?cljs.spec.alpha.__GT_sym.cljs$lang$test:null)]));
return (fexpr__68964.cljs$core$IFn$_invoke$arity$1 ? fexpr__68964.cljs$core$IFn$_invoke$arity$1(v__$1) : fexpr__68964.call(null,v__$1));
})())," did not conform to spec:\n",(function (){var sb__4661__auto__ = (new goog.string.StringBuffer());
var _STAR_print_newline_STAR__orig_val__68965_69108 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__68966_69109 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__68967_69110 = true;
var _STAR_print_fn_STAR__temp_val__68968_69111 = ((function (_STAR_print_newline_STAR__orig_val__68965_69108,_STAR_print_fn_STAR__orig_val__68966_69109,_STAR_print_newline_STAR__temp_val__68967_69110,sb__4661__auto__,caller,via,ed,conformed,fn_spec){
return (function (x__4662__auto__){
return sb__4661__auto__.append(x__4662__auto__);
});})(_STAR_print_newline_STAR__orig_val__68965_69108,_STAR_print_fn_STAR__orig_val__68966_69109,_STAR_print_newline_STAR__temp_val__68967_69110,sb__4661__auto__,caller,via,ed,conformed,fn_spec))
;
cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__68967_69110;

cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__68968_69111;

try{cljs.spec.alpha.explain_out(ed);
}finally {cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__68966_69109;

cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__68965_69108;
}
...
var ret = (function (){var _STAR_instrument_enabled_STAR__orig_val__68969 = orchestra_cljs.spec.test._STAR_instrument_enabled_STAR_;
var _STAR_instrument_enabled_STAR__temp_val__68970 = true;
orchestra_cljs.spec.test._STAR_instrument_enabled_STAR_ = _STAR_instrument_enabled_STAR__temp_val__68970;

try{return apply_SINGLEQUOTE_(f,args);
}finally {orchestra_cljs.spec.test._STAR_instrument_enabled_STAR_ = _STAR_instrument_enabled_STAR__orig_val__68969;
}})();
...
var temp__5735__auto___69117 = new cljs.core.Keyword(null,"fn","fn",-1175266204).cljs$core$IFn$_invoke$arity$1(fn_spec);
if(cljs.core.truth_(temp__5735__auto___69117)){
var spec_69118 = temp__5735__auto___69117;
if((cargs == null)){
throw orchestra_cljs.spec.test.no_args_spec(v,fn_spec);
} else {
conform_BANG_(v,new cljs.core.Keyword(null,"fn","fn",-1175266204),spec_69118,new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"ret","ret",-468222814),(function (){var or__4131__auto__ = cret;
...
return ret;
}finally {orchestra_cljs.spec.test._STAR_instrument_enabled_STAR_ = orig__68865__auto__;
}} else {
return apply_SINGLEQUOTE_(f,args);
}
};
var G__69114 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__69120__i = 0, G__69120__a = new Array(arguments.length -  0);
while (G__69120__i < G__69120__a.length) {G__69120__a[G__69120__i] = arguments[G__69120__i + 0]; ++G__69120__i;}
  args = new cljs.core.IndexedSeq(G__69120__a,0,null);
} 
return G__69114__delegate.call(this,args);};
G__69114.cljs$lang$maxFixedArity = 0;
G__69114.cljs$lang$applyTo = (function (arglist__69122){
var args = cljs.core.seq(arglist__69122);
return G__69114__delegate(args);
});
G__69114.cljs$core$IFn$_invoke$arity$variadic = G__69114__delegate;
return G__69114;
})()
...
var temp__5739__auto___69165 = f.cljs$core$IFn$_invoke$arity$variadic;
if((temp__5739__auto___69165 == null)){
} else {
var variadic_69166 = temp__5739__auto___69165;
ret.cljs$core$IFn$_invoke$arity$variadic = ((function (variadic_69166,temp__5739__auto___69165,fn_spec,conform_BANG_,pure_variadic_QMARK_,apply_SINGLEQUOTE_,ret){
return (function() { 
var G__69167__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(variadic_69166,args);
};
var G__69167 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__69168__i = 0, G__69168__a = new Array(arguments.length -  0);
while (G__69168__i < G__69168__a.length) {G__69168__a[G__69168__i] = arguments[G__69168__i + 0]; ++G__69168__i;}
  args = new cljs.core.IndexedSeq(G__69168__a,0,null);
} 
return G__69167__delegate.call(this,args);};
G__69167.cljs$lang$maxFixedArity = 0;
G__69167.cljs$lang$applyTo = (function (arglist__69169){
var args = cljs.core.seq(arglist__69169);
return G__69167__delegate(args);
});
G__69167.cljs$core$IFn$_invoke$arity$variadic = G__69167__delegate;
return G__69167;
})()
;})(variadic_69166,temp__5739__auto___69165,fn_spec,conform_BANG_,pure_variadic_QMARK_,apply_SINGLEQUOTE_,ret))
;
}
}
 ...
 */
orchestra_cljs.spec.test.instrument_choose_fn = (function orchestra_cljs$spec$test$instrument_choose_fn(f,spec,sym,p__69020){
var map__69022 = p__69020;
var map__69022__$1 = (((((!((map__69022 == null))))?(((((map__69022.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__69022.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__69022):map__69022);
var over = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__69022__$1,new cljs.core.Keyword(null,"gen","gen",142575302));
var stub = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__69022__$1,new cljs.core.Keyword(null,"stub","stub",1339145807));
var replace = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__69022__$1,new cljs.core.Keyword(null,"replace","replace",-786587770));
 ...
 * Helper for instrument
 */
orchestra_cljs.spec.test.instrument_choose_spec = (function orchestra_cljs$spec$test$instrument_choose_spec(spec,sym,p__69030){
var map__69031 = p__69030;
var map__69031__$1 = (((((!((map__69031 == null))))?(((((map__69031.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__69031.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__69031):map__69031);
var overrides = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__69031__$1,new cljs.core.Keyword(null,"spec","spec",347520401));
...
var map__69036 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(cljs.core.deref(orchestra_cljs.spec.test.instrumented_vars),v);
var map__69036__$1 = (((((!((map__69036 == null))))?(((((map__69036.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__69036.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__69036):map__69036);
var raw = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__69036__$1,new cljs.core.Keyword(null,"raw","raw",1604651272));
var wrapped = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__69036__$1,new cljs.core.Keyword(null,"wrapped","wrapped",1775172701));
...
var temp__5735__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(cljs.core.deref(orchestra_cljs.spec.test.instrumented_vars),v);
if(cljs.core.truth_(temp__5735__auto__)){
var map__69045 = temp__5735__auto__;
...
var raw = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__69045__$1,new cljs.core.Keyword(null,"raw","raw",1604651272));
var wrapped = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__69045__$1,new cljs.core.Keyword(null,"wrapped","wrapped",1775172701));
