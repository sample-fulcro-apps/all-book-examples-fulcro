...
var form = (function (){var G__66906 = via;
var G__66906__$1 = (((G__66906 == null))?null:cljs.core.last(G__66906));
if((G__66906__$1 == null)){
return null;
} else {
return cljs.spec.alpha.form(G__66906__$1);
}
})();
...
var seq__66912_67359 = cljs.core.seq(problems);
var chunk__66913_67360 = null;
var count__66914_67361 = (0);
var i__66915_67362 = (0);
while(true){
if((i__66915_67362 < count__66914_67361)){
var p_67363 = chunk__66913_67360.cljs$core$IIndexed$_nth$arity$2(null,i__66915_67362);
if((!((new cljs.core.Keyword("expound","via","expound/via",-595987777).cljs$core$IFn$_invoke$arity$1(p_67363) == null)))){
} else {
throw (new Error(["Assert failed: ",expound.util.assert_message,"\n","(some? (:expound/via p))"].join('')));
}


var G__67367 = seq__66912_67359;
var G__67368 = chunk__66913_67360;
var G__67369 = count__66914_67361;
var G__67370 = (i__66915_67362 + (1));
seq__66912_67359 = G__67367;
chunk__66913_67360 = G__67368;
count__66914_67361 = G__67369;
i__66915_67362 = G__67370;
continue;
} else {
var temp__5735__auto___67371 = cljs.core.seq(seq__66912_67359);
if(temp__5735__auto___67371){
var seq__66912_67372__$1 = temp__5735__auto___67371;
if(cljs.core.chunked_seq_QMARK_(seq__66912_67372__$1)){
var c__4550__auto___67373 = cljs.core.chunk_first(seq__66912_67372__$1);
var G__67375 = cljs.core.chunk_rest(seq__66912_67372__$1);
var G__67376 = c__4550__auto___67373;
var G__67377 = cljs.core.count(c__4550__auto___67373);
var G__67378 = (0);
seq__66912_67359 = G__67375;
chunk__66913_67360 = G__67376;
count__66914_67361 = G__67377;
i__66915_67362 = G__67378;
continue;
} else {
var p_67381 = cljs.core.first(seq__66912_67372__$1);
if((!((new cljs.core.Keyword("expound","via","expound/via",-595987777).cljs$core$IFn$_invoke$arity$1(p_67381) == null)))){
} else {
throw (new Error(["Assert failed: ",expound.util.assert_message,"\n","(some? (:expound/via p))"].join('')));
}


var G__67382 = cljs.core.next(seq__66912_67372__$1);
var G__67383 = null;
var G__67384 = (0);
var G__67385 = (0);
seq__66912_67359 = G__67382;
chunk__66913_67360 = G__67383;
count__66914_67361 = G__67384;
i__66915_67362 = G__67385;
continue;
}
} else {
}
...
return (function (p1__66910_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(cljs.core.name(k),cljs.core.name(p1__66910_SHARP_));
});})(vias,specs))
,specs))));
});})(vias,specs))
...
expound.printer.summarize_key_clause = (function expound$printer$summarize_key_clause(p__66938){
var vec__66939 = p__66938;
var branch = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__66939,(0),null);
var match = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__66939,(1),null);
var G__66942 = branch;
var G__66942__$1 = (((G__66942 instanceof cljs.core.Keyword))?G__66942.fqn:null);
switch (G__66942__$1) {
case "simple":
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__66942__$1)].join('')));

}
});
expound.printer.missing_key = (function expound$printer$missing_key(form){
var vec__66943 = cljs.spec.alpha.conform(new cljs.core.Keyword("expound.spec","contains-key-pred","expound.spec/contains-key-pred",-989075236),cljs.core.nth.cljs$core$IFn$_invoke$arity$2(form,(2)));
var branch = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__66943,(0),null);
var match = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__66943,(1),null);
var G__66946 = branch;
var G__66946__$1 = (((G__66946 instanceof cljs.core.Keyword))?G__66946.fqn:null);
switch (G__66946__$1) {
case "simple":
return new cljs.core.Keyword(null,"kw","kw",1158308175).cljs$core$IFn$_invoke$arity$1(match);
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__66946__$1)].join('')));
...
var len__4730__auto___67415 = arguments.length;
var i__4731__auto___67416 = (0);
while(true){
if((i__4731__auto___67416 < len__4730__auto___67415)){
args__4736__auto__.push((arguments[i__4731__auto___67416]));

var G__67417 = (i__4731__auto___67416 + (1));
i__4731__auto___67416 = G__67417;
continue;
} else {
}
break;
...
/** @this {Function} */
expound.printer.format.cljs$lang$applyTo = (function (seq66947){
var G__66948 = cljs.core.first(seq66947);
var seq66947__$1 = cljs.core.next(seq66947);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__66948,seq66947__$1);
});
...
var keys = expound.printer.keywords(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__66949_SHARP_){
return expound.printer.missing_key(new cljs.core.Keyword(null,"pred","pred",1927423397).cljs$core$IFn$_invoke$arity$1(p1__66949_SHARP_));
}),problems));
...
var _STAR_print_newline_STAR__orig_val__66952_67424 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__66953_67425 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__66954_67426 = true;
var _STAR_print_fn_STAR__temp_val__66955_67427 = ((function (_STAR_print_newline_STAR__orig_val__66952_67424,_STAR_print_fn_STAR__orig_val__66953_67425,_STAR_print_newline_STAR__temp_val__66954_67426,sb__4661__auto__,keys){
return (function (x__4662__auto__){
return sb__4661__auto__.append(x__4662__auto__);
});})(_STAR_print_newline_STAR__orig_val__66952_67424,_STAR_print_fn_STAR__orig_val__66953_67425,_STAR_print_newline_STAR__temp_val__66954_67426,sb__4661__auto__,keys))
;
cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__66954_67426;

cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__66955_67427;

try{cljs.pprint.print_table.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, ["key","spec"], null),cljs.core.sort_by.cljs$core$IFn$_invoke$arity$2(((function (_STAR_print_newline_STAR__orig_val__66952_67424,_STAR_print_fn_STAR__orig_val__66953_67425,_STAR_print_newline_STAR__temp_val__66954_67426,_STAR_print_fn_STAR__temp_val__66955_67427,sb__4661__auto__,keys){
return (function (p1__66950_SHARP_){
return cljs.core.get.cljs$core$IFn$_invoke$arity$2(p1__66950_SHARP_,"key");
});})(_STAR_print_newline_STAR__orig_val__66952_67424,_STAR_print_fn_STAR__orig_val__66953_67425,_STAR_print_newline_STAR__temp_val__66954_67426,_STAR_print_fn_STAR__temp_val__66955_67427,sb__4661__auto__,keys))
,cljs.core.map.cljs$core$IFn$_invoke$arity$2(((function (_STAR_print_newline_STAR__orig_val__66952_67424,_STAR_print_fn_STAR__orig_val__66953_67425,_STAR_print_newline_STAR__temp_val__66954_67426,_STAR_print_fn_STAR__temp_val__66955_67427,sb__4661__auto__,keys){
return (function (p__66963){
var vec__66964 = p__66963;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__66964,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__66964,(1),null);
...
}finally {cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__66953_67425;

cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__66952_67424;
}
...
return (function (p1__66970_SHARP_){
return expound.ansi.color.cljs$core$IFn$_invoke$arity$variadic(p1__66970_SHARP_,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"correct-key","correct-key",1087492967)], 0));
});})(keys_clauses))
...
var vec__67229 = clojure.string.split_lines(cljs.core.str.cljs$core$IFn$_invoke$arity$1(s));
var seq__67230 = cljs.core.seq(vec__67229);
var first__67231 = cljs.core.first(seq__67230);
var seq__67230__$1 = cljs.core.next(seq__67230);
var line = first__67231;
var lines = seq__67230__$1;
return clojure.string.join.cljs$core$IFn$_invoke$arity$2("\n",cljs.core.into.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [[cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.str,cljs.core.repeat.cljs$core$IFn$_invoke$arity$2(first_line_indent," "))),cljs.core.str.cljs$core$IFn$_invoke$arity$1(line)].join('')], null),cljs.core.map.cljs$core$IFn$_invoke$arity$2(((function (vec__67229,seq__67230,first__67231,seq__67230__$1,line,lines){
return (function (p1__67147_SHARP_){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.str,cljs.core.repeat.cljs$core$IFn$_invoke$arity$2(rest_lines_indent," "))),cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__67147_SHARP_)].join('');
});})(vec__67229,seq__67230,first__67231,seq__67230__$1,line,lines))
,lines)));
});
