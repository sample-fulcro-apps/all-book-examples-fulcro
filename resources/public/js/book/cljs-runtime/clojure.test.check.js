...
var vec__45744 = temp__5733__auto__;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45744,(0),null);
var e = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45744,(1),null);
...
var len__4730__auto___45778 = arguments.length;
var i__4731__auto___45779 = (0);
while(true){
if((i__4731__auto___45779 < len__4730__auto___45778)){
args__4736__auto__.push((arguments[i__4731__auto___45779]));

var G__45780 = (i__4731__auto___45779 + (1));
i__4731__auto___45779 = G__45780;
continue;
} else {
}
break;
...
clojure.test.check.quick_check.cljs$core$IFn$_invoke$arity$variadic = (function (num_tests,property,p__45750){
var map__45751 = p__45750;
var map__45751__$1 = (((((!((map__45751 == null))))?(((((map__45751.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__45751.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__45751):map__45751);
var seed = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45751__$1,new cljs.core.Keyword(null,"seed","seed",68613327));
var max_size = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__45751__$1,new cljs.core.Keyword(null,"max-size","max-size",-874966132),(200));
var reporter_fn = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__45751__$1,new cljs.core.Keyword(null,"reporter-fn","reporter-fn",1280520247),cljs.core.constantly(null));
var vec__45753 = clojure.test.check.make_rng(seed);
var created_seed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45753,(0),null);
var rng = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45753,(1),null);
...
var vec__45763 = size_seq__$1;
var seq__45764 = cljs.core.seq(vec__45763);
var first__45765 = cljs.core.first(seq__45764);
var seq__45764__$1 = cljs.core.next(seq__45764);
var size = first__45765;
var rest_size_seq = seq__45764__$1;
var vec__45766 = clojure.test.check.random.split(rstate);
var r1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45766,(0),null);
var r2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45766,(1),null);
...
/** @this {Function} */
clojure.test.check.quick_check.cljs$lang$applyTo = (function (seq45747){
...
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__45748,G__45749,seq45747__$2);
});
...
var result = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45770__$1,new cljs.core.Keyword(null,"result","result",1415092211));
...
var G__45786 = tail;
var G__45787 = current_smallest;
var G__45788 = (total_nodes_visited + (1));
var G__45789 = depth;
nodes = G__45786;
current_smallest = G__45787;
total_nodes_visited = G__45788;
depth = G__45789;
continue;
} else {
var new_smallest = clojure.test.check.rose_tree.root(head);
var G__45772_45790 = cljs.core.assoc_in(reporter_fn_arg,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"shrinking","shrinking",2049648186),new cljs.core.Keyword(null,"smallest","smallest",-152623883)], null),new cljs.core.Keyword(null,"args","args",1315556576).cljs$core$IFn$_invoke$arity$1(new_smallest));
(reporter_fn.cljs$core$IFn$_invoke$arity$1 ? reporter_fn.cljs$core$IFn$_invoke$arity$1(G__45772_45790) : reporter_fn.call(null,G__45772_45790));

var temp__5733__auto__ = cljs.core.seq(clojure.test.check.rose_tree.children(head));
if(temp__5733__auto__){
var children = temp__5733__auto__;
var G__45794 = children;
var G__45795 = new_smallest;
var G__45796 = (total_nodes_visited + (1));
var G__45797 = (depth + (1));
nodes = G__45794;
current_smallest = G__45795;
total_nodes_visited = G__45796;
depth = G__45797;
continue;
} else {
var G__45798 = tail;
var G__45799 = new_smallest;
var G__45800 = (total_nodes_visited + (1));
var G__45801 = depth;
nodes = G__45798;
current_smallest = G__45799;
total_nodes_visited = G__45800;
depth = G__45801;
continue;
}
}
...
var G__45774_45802 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(failure_data,new cljs.core.Keyword(null,"type","type",1174270348),new cljs.core.Keyword(null,"failure","failure",720415879));
(reporter_fn.cljs$core$IFn$_invoke$arity$1 ? reporter_fn.cljs$core$IFn$_invoke$arity$1(G__45774_45802) : reporter_fn.call(null,G__45774_45802));
...
var G__45775 = cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([failure_data,p1__45773_SHARP_], 0));
return (reporter_fn.cljs$core$IFn$_invoke$arity$1 ? reporter_fn.cljs$core$IFn$_invoke$arity$1(G__45775) : reporter_fn.call(null,G__45775));
});})(failed_after_ms,root,result,failure_data))
);
var G__45776_45803 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$variadic(failure_data,new cljs.core.Keyword(null,"type","type",1174270348),new cljs.core.Keyword(null,"shrunk","shrunk",-2041664412),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"shrunk","shrunk",-2041664412),shrunk], 0));
(reporter_fn.cljs$core$IFn$_invoke$arity$1 ? reporter_fn.cljs$core$IFn$_invoke$arity$1(G__45776_45803) : reporter_fn.call(null,G__45776_45803));
