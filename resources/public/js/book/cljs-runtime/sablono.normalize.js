...
return cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentArrayMap.EMPTY,cljs.core.remove.cljs$core$IFn$_invoke$arity$1((function (p__76622){
var vec__76623 = p__76622;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__76623,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__76623,(1),null);
...
if(((((cljs.core.set_QMARK_(class$)) || (cljs.core.sequential_QMARK_(class$)))) && (cljs.core.every_QMARK_((function (p1__76626_SHARP_){
return (((p1__76626_SHARP_ instanceof cljs.core.Keyword)) || (typeof p1__76626_SHARP_ === 'string'));
}),class$)))){
...
return cljs.core.update_in.cljs$core$IFn$_invoke$arity$3(G__76627,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"class","class",-2030961996)], null),sablono.normalize.class$);
} else {
return G__76627;
}
});
...
var len__4730__auto___76666 = arguments.length;
var i__4731__auto___76667 = (0);
while(true){
if((i__4731__auto___76667 < len__4730__auto___76666)){
args__4736__auto__.push((arguments[i__4731__auto___76667]));

var G__76668 = (i__4731__auto___76667 + (1));
i__4731__auto___76667 = G__76668;
continue;
} else {
}
break;
...
var G__76631 = cljs.core.reduce.cljs$core$IFn$_invoke$arity$3(cljs.core.into,cljs.core.PersistentArrayMap.EMPTY,maps__$1);
if((!(cljs.core.empty_QMARK_(classes)))){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__76631,new cljs.core.Keyword(null,"class","class",-2030961996),cljs.core.vec(classes));
} else {
return G__76631;
}
} else {
...
/** @this {Function} */
sablono.normalize.merge_with_class.cljs$lang$applyTo = (function (seq76629){
var self__4718__auto__ = this;
return self__4718__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq76629));
});
...
var vec__76636 = ((cljs.core.empty_QMARK_(matches))?(function(){throw cljs.core.ex_info.cljs$core$IFn$_invoke$arity$2(["Can't match CSS tag: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(s)].join(''),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"tag","tag",-1290361223),s], null))})():(cljs.core.truth_((function (){var G__76644 = cljs.core.ffirst(matches);
var fexpr__76643 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, ["#",null,".",null], null), null);
return (fexpr__76643.cljs$core$IFn$_invoke$arity$1 ? fexpr__76643.cljs$core$IFn$_invoke$arity$1(G__76644) : fexpr__76643.call(null,G__76644));
...
var tag_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__76636,(0),null);
var names = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__76636,(1),null);
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [tag_name,sablono.normalize.strip_css(cljs.core.some(((function (matches,vec__76636,tag_name,names){
return (function (p1__76634_SHARP_){
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("#",cljs.core.first(p1__76634_SHARP_))){
return p1__76634_SHARP_;
} else {
return null;
}
});})(matches,vec__76636,tag_name,names))
,names)),cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentVector.EMPTY,cljs.core.comp.cljs$core$IFn$_invoke$arity$2(cljs.core.filter.cljs$core$IFn$_invoke$arity$1(((function (matches,vec__76636,tag_name,names){
return (function (p1__76635_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(".",cljs.core.first(p1__76635_SHARP_));
});})(matches,vec__76636,tag_name,names))
 ...
 */
sablono.normalize.element = (function sablono$normalize$element(p__76646){
var vec__76647 = p__76646;
var seq__76648 = cljs.core.seq(vec__76647);
var first__76649 = cljs.core.first(seq__76648);
var seq__76648__$1 = cljs.core.next(seq__76648);
var tag = first__76649;
var content = seq__76648__$1;
...
var vec__76654 = sablono.normalize.match_tag(tag);
var tag__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__76654,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__76654,(1),null);
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__76654,(2),null);
