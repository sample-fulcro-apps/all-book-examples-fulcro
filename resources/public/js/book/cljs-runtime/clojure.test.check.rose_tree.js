...
return cljs.core.cons(cljs.core.first(s),(function (){var G__44991 = (n - (1));
var G__44992 = cljs.core.rest(s);
return (clojure.test.check.rose_tree.exclude_nth.cljs$core$IFn$_invoke$arity$2 ? clojure.test.check.rose_tree.exclude_nth.cljs$core$IFn$_invoke$arity$2(G__44991,G__44992) : clojure.test.check.rose_tree.exclude_nth.call(null,G__44991,G__44992));
})());
}
} else {
return null;
...
return clojure.test.check.rose_tree.make_rose((function (){var G__45010 = clojure.test.check.rose_tree.root(rose);
return (f.cljs$core$IFn$_invoke$arity$1 ? f.cljs$core$IFn$_invoke$arity$1(G__45010) : f.call(null,G__45010));
})(),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__45009_SHARP_){
return (clojure.test.check.rose_tree.fmap.cljs$core$IFn$_invoke$arity$2 ? clojure.test.check.rose_tree.fmap.cljs$core$IFn$_invoke$arity$2(f,p1__45009_SHARP_) : clojure.test.check.rose_tree.fmap.call(null,f,p1__45009_SHARP_));
...
return clojure.test.check.rose_tree.make_rose(clojure.test.check.rose_tree.root(rose),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__45011_SHARP_){
return (clojure.test.check.rose_tree.filter.cljs$core$IFn$_invoke$arity$2 ? clojure.test.check.rose_tree.filter.cljs$core$IFn$_invoke$arity$2(pred,p1__45011_SHARP_) : clojure.test.check.rose_tree.filter.call(null,pred,p1__45011_SHARP_));
}),cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__45012_SHARP_){
var G__45013 = clojure.test.check.rose_tree.root(p1__45012_SHARP_);
return (pred.cljs$core$IFn$_invoke$arity$1 ? pred.cljs$core$IFn$_invoke$arity$1(G__45013) : pred.call(null,G__45013));
}),clojure.test.check.rose_tree.children(rose))));
});
/**
...
var iter__4523__auto__ = (function clojure$test$check$rose_tree$permutations_$_iter__45014(s__45015){
return (new cljs.core.LazySeq(null,(function (){
var s__45015__$1 = s__45015;
while(true){
var temp__5735__auto__ = cljs.core.seq(s__45015__$1);
if(temp__5735__auto__){
var xs__6292__auto__ = temp__5735__auto__;
var vec__45039 = cljs.core.first(xs__6292__auto__);
var rose = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45039,(0),null);
var index = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45039,(1),null);
var iterys__4519__auto__ = ((function (s__45015__$1,vec__45039,rose,index,xs__6292__auto__,temp__5735__auto__){
return (function clojure$test$check$rose_tree$permutations_$_iter__45014_$_iter__45016(s__45017){
return (new cljs.core.LazySeq(null,((function (s__45015__$1,vec__45039,rose,index,xs__6292__auto__,temp__5735__auto__){
return (function (){
var s__45017__$1 = s__45017;
while(true){
var temp__5735__auto____$1 = cljs.core.seq(s__45017__$1);
if(temp__5735__auto____$1){
var s__45017__$2 = temp__5735__auto____$1;
if(cljs.core.chunked_seq_QMARK_(s__45017__$2)){
var c__4521__auto__ = cljs.core.chunk_first(s__45017__$2);
var size__4522__auto__ = cljs.core.count(c__4521__auto__);
var b__45019 = cljs.core.chunk_buffer(size__4522__auto__);
if((function (){var i__45018 = (0);
while(true){
if((i__45018 < size__4522__auto__)){
var child = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__4521__auto__,i__45018);
cljs.core.chunk_append(b__45019,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(roses,index,child));

var G__45158 = (i__45018 + (1));
i__45018 = G__45158;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__45019),clojure$test$check$rose_tree$permutations_$_iter__45014_$_iter__45016(cljs.core.chunk_rest(s__45017__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__45019),null);
}
} else {
var child = cljs.core.first(s__45017__$2);
return cljs.core.cons(cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(roses,index,child),clojure$test$check$rose_tree$permutations_$_iter__45014_$_iter__45016(cljs.core.rest(s__45017__$2)));
}
} else {
return null;
}
...
});})(s__45015__$1,vec__45039,rose,index,xs__6292__auto__,temp__5735__auto__))
,null,null));
});})(s__45015__$1,vec__45039,rose,index,xs__6292__auto__,temp__5735__auto__))
;
var fs__4520__auto__ = cljs.core.seq(iterys__4519__auto__(clojure.test.check.rose_tree.children(rose)));
if(fs__4520__auto__){
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(fs__4520__auto__,clojure$test$check$rose_tree$permutations_$_iter__45014(cljs.core.rest(s__45015__$1)));
} else {
var G__45161 = cljs.core.rest(s__45015__$1);
s__45015__$1 = G__45161;
continue;
}
} else {
return null;
...
return clojure.test.check.rose_tree.make_rose(cljs.core.apply.cljs$core$IFn$_invoke$arity$2(f,cljs.core.map.cljs$core$IFn$_invoke$arity$2(clojure.test.check.rose_tree.root,roses)),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__45045_SHARP_){
return (clojure.test.check.rose_tree.zip.cljs$core$IFn$_invoke$arity$2 ? clojure.test.check.rose_tree.zip.cljs$core$IFn$_invoke$arity$2(f,p1__45045_SHARP_) : clojure.test.check.rose_tree.zip.call(null,f,p1__45045_SHARP_));
...
return clojure.test.check.rose_tree.make_rose(cljs.core.apply.cljs$core$IFn$_invoke$arity$2(f,cljs.core.map.cljs$core$IFn$_invoke$arity$2(clojure.test.check.rose_tree.root,roses)),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__45047_SHARP_){
return (clojure.test.check.rose_tree.shrink.cljs$core$IFn$_invoke$arity$2 ? clojure.test.check.rose_tree.shrink.cljs$core$IFn$_invoke$arity$2(f,p1__45047_SHARP_) : clojure.test.check.rose_tree.shrink.call(null,f,p1__45047_SHARP_));
...
return (function (){
return cljs.core.cons((function (){var G__45059 = f;
var G__45060 = cljs.core.subvec.cljs$core$IFn$_invoke$arity$3(roses,(0),left_count);
return (clojure.test.check.rose_tree.shrink_vector_STAR_.cljs$core$IFn$_invoke$arity$2 ? clojure.test.check.rose_tree.shrink_vector_STAR_.cljs$core$IFn$_invoke$arity$2(G__45059,G__45060) : clojure.test.check.rose_tree.shrink_vector_STAR_.call(null,G__45059,G__45060));
})(),(new cljs.core.LazySeq(null,((function (left_count){
return (function (){
return (new cljs.core.List(null,(function (){var G__45063 = f;
var G__45064 = cljs.core.subvec.cljs$core$IFn$_invoke$arity$2(roses,left_count);
return (clojure.test.check.rose_tree.shrink_vector_STAR_.cljs$core$IFn$_invoke$arity$2 ? clojure.test.check.rose_tree.shrink_vector_STAR_.cljs$core$IFn$_invoke$arity$2(G__45063,G__45064) : clojure.test.check.rose_tree.shrink_vector_STAR_.call(null,G__45063,G__45064));
})(),null,(1),null));
});})(left_count))
,null,null)));
});})(left_count))
