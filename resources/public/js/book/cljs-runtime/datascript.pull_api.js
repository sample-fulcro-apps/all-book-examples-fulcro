...
var map__59435 = rec;
var map__59435__$1 = (((((!((map__59435 == null))))?(((((map__59435.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__59435.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__59435):map__59435);
var depth = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__59435__$1,new cljs.core.Keyword(null,"depth","depth",1768663640));
var seen = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__59435__$1,new cljs.core.Keyword(null,"seen","seen",-518999789));
...
var G__59448 = new cljs.core.Keyword(null,"kvps","kvps",65308317).cljs$core$IFn$_invoke$arity$1(frame);
var G__59448__$1 = (((G__59448 == null))?null:cljs.core.persistent_BANG_(G__59448));
if((G__59448__$1 == null)){
return null;
} else {
return cljs.core.get.cljs$core$IFn$_invoke$arity$2(G__59448__$1,key);
}
});
...
datascript.pull_api.pull_recursion_frame = (function datascript$pull_api$pull_recursion_frame(db,p__59451){
...
var frame = first__59454;
var frames = seq__59453__$1;
...
var or__4131__auto__ = datascript.pull_api.pull_seen_eid(frame__$1,frames,eid);
...
var results = (function (){var G__59456 = new cljs.core.Keyword(null,"results","results",-1134170113).cljs$core$IFn$_invoke$arity$1(frame);
if(cljs.core.seq(kvps)){
return cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(G__59456,kvps);
} else {
return G__59456;
}
})();
...
var recursion = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__59457__$1,new cljs.core.Keyword(null,"recursion","recursion",-749738765));
var pattern = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__59457__$1,new cljs.core.Keyword(null,"pattern","pattern",242135423));
...
var pattern_59564 = (new datascript.pull_parser.PullSpec(true,cljs.core.PersistentArrayMap.EMPTY,null,null,null));
datascript.pull_api.expand_frame = ((function (pattern_59564){
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(datascript.pull_api.subpattern_frame(pattern_59564,eids,multi_QMARK_,attr_key),new cljs.core.Keyword(null,"recursion","recursion",-749738765),rec);
});})(pattern_59564))
;
datascript.pull_api.pull_attr_datoms = (function datascript$pull_api$pull_attr_datoms(db,attr_key,attr,eid,forward_QMARK_,datoms,opts,p__59471){
...
var parent = first__59474;
var frames = seq__59473__$1;
...
var found = cljs.core.not_empty((function (){var G__59475 = datoms;
if(cljs.core.truth_(limit)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentVector.EMPTY,cljs.core.take.cljs$core$IFn$_invoke$arity$1(limit),G__59475);
} else {
return G__59475;
}
})());
...
var datom_val = (cljs.core.truth_(forward_QMARK_)?((function (ref_QMARK_,component_QMARK_,multi_QMARK_,limit,attr_key__$1,found,vec__59472,seq__59473,first__59474,seq__59473__$1,parent,frames){
return (function (d){
return d.v;
});})(ref_QMARK_,component_QMARK_,multi_QMARK_,limit,attr_key__$1,found,vec__59472,seq__59473,first__59474,seq__59473__$1,parent,frames))
:((function (ref_QMARK_,component_QMARK_,multi_QMARK_,limit,attr_key__$1,found,vec__59472,seq__59473,first__59474,seq__59473__$1,parent,frames){
return (function (d){
return d.e;
});})(ref_QMARK_,component_QMARK_,multi_QMARK_,limit,attr_key__$1,found,vec__59472,seq__59473,first__59474,seq__59473__$1,parent,frames))
);
...
var as_value = (function (){var G__59484 = datom_val;
if(ref_QMARK_){
return cljs.core.comp.cljs$core$IFn$_invoke$arity$2(((function (G__59484,ref_QMARK_,component_QMARK_,multi_QMARK_,datom_val,limit,attr_key__$1,found,vec__59472,seq__59473,first__59474,seq__59473__$1,parent,frames){
return (function (p1__59468_SHARP_){
return cljs.core.PersistentHashMap.fromArrays([new cljs.core.Keyword("db","id","db/id",-1388397098)],[p1__59468_SHARP_]);
});})(G__59484,ref_QMARK_,component_QMARK_,multi_QMARK_,datom_val,limit,attr_key__$1,found,vec__59472,seq__59473,first__59474,seq__59473__$1,parent,frames))
,G__59484);
} else {
return G__59484;
}
...
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(frames,cljs.core.update.cljs$core$IFn$_invoke$arity$5(parent,new cljs.core.Keyword(null,"kvps","kvps",65308317),cljs.core.assoc_BANG_,attr_key__$1,(function (){var G__59485 = cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentVector.EMPTY,cljs.core.map.cljs$core$IFn$_invoke$arity$1(as_value),found);
if(single_QMARK_){
return cljs.core.first(G__59485);
} else {
return G__59485;
}
})()));
...
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(frames,(function (){var G__59487 = parent;
if(cljs.core.contains_QMARK_(opts,new cljs.core.Keyword(null,"default","default",-1987822328))){
return cljs.core.update.cljs$core$IFn$_invoke$arity$5(G__59487,new cljs.core.Keyword(null,"kvps","kvps",65308317),cljs.core.assoc_BANG_,attr_key__$1,new cljs.core.Keyword(null,"default","default",-1987822328).cljs$core$IFn$_invoke$arity$1(opts));
} else {
return G__59487;
}
})());
...
var vec__59492 = spec;
var attr_key = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__59492,(0),null);
var opts = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__59492,(1),null);
...
datascript.pull_api.filter_reverse_attrs = cljs.core.filter.cljs$core$IFn$_invoke$arity$1((function (p__59495){
var vec__59496 = p__59495;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__59496,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__59496,(1),null);
...
datascript.pull_api.pull_expand_reverse_frame = (function datascript$pull_api$pull_expand_reverse_frame(db,p__59503){
...
var frame = first__59506;
var frames = seq__59505__$1;
return datascript.pull_api.expand_result(frames,datascript.pull_api.into_BANG_(new cljs.core.Keyword(null,"expand-kvps","expand-kvps",44141154).cljs$core$IFn$_invoke$arity$1(frame),(function (){var or__4131__auto__ = datascript.pull_api.single_frame_result(new cljs.core.Keyword("datascript.pull-api","expand-rev","datascript.pull-api/expand-rev",2143627459),frame);
if(cljs.core.truth_(or__4131__auto__)){
return or__4131__auto__;
} else {
...
datascript.pull_api.pull_expand_frame = (function datascript$pull_api$pull_expand_frame(db,p__59507){
...
var frame = first__59510;
var frames = seq__59509__$1;
...
var vec__59511 = cljs.core.first(datoms_by_attr);
var attr = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__59511,(0),null);
var datoms = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__59511,(1),null);
...
var attr = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__59515__$1,new cljs.core.Keyword(null,"attr","attr",-604132353));
var recursion = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__59515__$1,new cljs.core.Keyword(null,"recursion","recursion",-749738765));
var rec = (function (){var G__59525 = recursion;
if((!((attr == null)))){
return datascript.pull_api.push_recursion(G__59525,attr,eid);
} else {
return G__59525;
}
})();
...
var eid = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__59526__$1,new cljs.core.Keyword(null,"eid","eid",559519930));
var pattern = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__59526__$1,new cljs.core.Keyword(null,"pattern","pattern",242135423));
var or__4131__auto__ = datascript.pull_api.pull_seen_eid(frame,frames,eid);
if(cljs.core.truth_(or__4131__auto__)){
return or__4131__auto__;
} else {
...
datascript.pull_api.pull_pattern_frame = (function datascript$pull_api$pull_pattern_frame(db,p__59533){
while(true){
...
var frame = first__59536;
var frames = seq__59535__$1;
var temp__5733__auto__ = cljs.core.seq(new cljs.core.Keyword(null,"eids","eids",1546550700).cljs$core$IFn$_invoke$arity$1(frame));
if(temp__5733__auto__){
var eids = temp__5733__auto__;
...
var G__59585 = db;
var G__59586 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(frames,datascript.pull_api.reset_frame(frame,cljs.core.rest(eids),cljs.core.not_empty(cljs.core.persistent_BANG_(new cljs.core.Keyword(null,"kvps","kvps",65308317).cljs$core$IFn$_invoke$arity$1(frame)))));
db = G__59585;
p__59533 = G__59586;
continue;
}
...
while(true){
var G__59537 = new cljs.core.Keyword(null,"state","state",-1988618099).cljs$core$IFn$_invoke$arity$1(cljs.core.first(frames));
var G__59537__$1 = (((G__59537 instanceof cljs.core.Keyword))?G__59537.fqn:null);
switch (G__59537__$1) {
case "expand":
var G__59588 = db;
var G__59589 = datascript.pull_api.pull_expand_frame(db,frames);
db = G__59588;
frames = G__59589;
continue;
...
case "expand-rev":
var G__59590 = db;
var G__59591 = datascript.pull_api.pull_expand_reverse_frame(db,frames);
db = G__59590;
frames = G__59591;
continue;
...
case "pattern":
var G__59592 = db;
var G__59593 = datascript.pull_api.pull_pattern_frame(db,frames);
db = G__59592;
frames = G__59593;
continue;
...
case "recursion":
var G__59594 = db;
var G__59595 = datascript.pull_api.pull_recursion_frame(db,frames);
db = G__59594;
frames = G__59595;
continue;
...
var f = first__59540;
var remaining = seq__59539__$1;
var result = (function (){var G__59541 = cljs.core.persistent_BANG_(new cljs.core.Keyword(null,"results","results",-1134170113).cljs$core$IFn$_invoke$arity$1(f));
if(cljs.core.not(new cljs.core.Keyword(null,"multi?","multi?",-749311069).cljs$core$IFn$_invoke$arity$1(f))){
return cljs.core.first(G__59541);
} else {
return G__59541;
}
})();
...
var G__59596 = db;
var G__59597 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.rest(remaining),(function (){var G__59542 = cljs.core.first(remaining);
if(cljs.core.truth_(result)){
return cljs.core.update.cljs$core$IFn$_invoke$arity$5(G__59542,new cljs.core.Keyword(null,"kvps","kvps",65308317),cljs.core.assoc_BANG_,new cljs.core.Keyword(null,"attr","attr",-604132353).cljs$core$IFn$_invoke$arity$1(f),result);
} else {
return G__59542;
}
})());
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__59537__$1)].join('')));
...
var eids__$1 = cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentVector.EMPTY,cljs.core.map.cljs$core$IFn$_invoke$arity$1((function (p1__59544_SHARP_){
return datascript.db.entid_strict(db,p1__59544_SHARP_);
})),eids);
