...
var G__44783 = z;
if(((24) > (function (){var G__44784 = clojure.test.check.random.bxoubsr(z,(1));
return (clojure.test.check.random.longs.bit_count.cljs$core$IFn$_invoke$arity$1 ? clojure.test.check.random.longs.bit_count.cljs$core$IFn$_invoke$arity$1(G__44784) : clojure.test.check.random.longs.bit_count.call(null,G__44784));
})())){
return clojure.test.check.random.longs.bit_xor(G__44783,clojure.test.check.random.mix_gamma_const_3);
} else {
return G__44783;
}
});
...
var G__44886 = state_SINGLEQUOTE__SINGLEQUOTE_;
var G__44887 = cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(ret,new_rng);
state__$1 = G__44886;
ret = G__44887;
continue;
}
...
var state = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__44815__$1,new cljs.core.Keyword(null,"state","state",-1988618099));
var vec__44817 = clojure.test.check.random.split(state);
var r1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__44817,(0),null);
var r2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__44817,(1),null);
