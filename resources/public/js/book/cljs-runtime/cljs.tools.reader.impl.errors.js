...
var len__4730__auto___46298 = arguments.length;
var i__4731__auto___46299 = (0);
while(true){
if((i__4731__auto___46299 < len__4730__auto___46298)){
...
/** @this {Function} */
cljs.tools.reader.impl.errors.throw_ex.cljs$lang$applyTo = (function (seq46262){
var G__46263 = cljs.core.first(seq46262);
var seq46262__$1 = cljs.core.next(seq46262);
var G__46264 = cljs.core.first(seq46262__$1);
var seq46262__$2 = cljs.core.next(seq46262__$1);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__46263,G__46264,seq46262__$2);
});
...
var args__4736__auto__ = [];
var len__4730__auto___46301 = arguments.length;
var i__4731__auto___46302 = (0);
while(true){
if((i__4731__auto___46302 < len__4730__auto___46301)){
args__4736__auto__.push((arguments[i__4731__auto___46302]));

var G__46303 = (i__4731__auto___46302 + (1));
i__4731__auto___46302 = G__46303;
continue;
} else {
}
break;
...
/** @this {Function} */
cljs.tools.reader.impl.errors.reader_error.cljs$lang$applyTo = (function (seq46266){
var G__46267 = cljs.core.first(seq46266);
var seq46266__$1 = cljs.core.next(seq46266);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__46267,seq46266__$1);
});
...
/** @this {Function} */
cljs.tools.reader.impl.errors.illegal_arg_error.cljs$lang$applyTo = (function (seq46268){
...
var args__4736__auto__ = [];
var len__4730__auto___46308 = arguments.length;
var i__4731__auto___46309 = (0);
while(true){
if((i__4731__auto___46309 < len__4730__auto___46308)){
args__4736__auto__.push((arguments[i__4731__auto___46309]));

var G__46310 = (i__4731__auto___46309 + (1));
i__4731__auto___46309 = G__46310;
continue;
} else {
}
break;
...
/** @this {Function} */
cljs.tools.reader.impl.errors.eof_error.cljs$lang$applyTo = (function (seq46270){
var G__46271 = cljs.core.first(seq46270);
var seq46270__$1 = cljs.core.next(seq46270);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__46271,seq46270__$1);
});
...
var args__4736__auto__ = [];
var len__4730__auto___46317 = arguments.length;
var i__4731__auto___46318 = (0);
while(true){
if((i__4731__auto___46318 < len__4730__auto___46317)){
args__4736__auto__.push((arguments[i__4731__auto___46318]));

var G__46319 = (i__4731__auto___46318 + (1));
i__4731__auto___46318 = G__46319;
continue;
} else {
}
break;
...
var init = (function (){var G__46277 = kind;
var G__46277__$1 = (((G__46277 instanceof cljs.core.Keyword))?G__46277.fqn:null);
switch (G__46277__$1) {
case "regex":
return "#\"";
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__46277__$1)].join('')));
...
/** @this {Function} */
cljs.tools.reader.impl.errors.throw_eof_reading.cljs$lang$applyTo = (function (seq46274){
...
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__46275,G__46276,seq46274__$2);
});
...
var iter__4523__auto__ = (function cljs$tools$reader$impl$errors$duplicate_keys_error_$_duplicates_$_iter__46288(s__46289){
return (new cljs.core.LazySeq(null,(function (){
var s__46289__$1 = s__46289;
while(true){
var temp__5735__auto__ = cljs.core.seq(s__46289__$1);
if(temp__5735__auto__){
var s__46289__$2 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_(s__46289__$2)){
var c__4521__auto__ = cljs.core.chunk_first(s__46289__$2);
var size__4522__auto__ = cljs.core.count(c__4521__auto__);
var b__46291 = cljs.core.chunk_buffer(size__4522__auto__);
if((function (){var i__46290 = (0);
while(true){
if((i__46290 < size__4522__auto__)){
var vec__46292 = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__4521__auto__,i__46290);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46292,(0),null);
var freq = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46292,(1),null);
if((freq > (1))){
cljs.core.chunk_append(b__46291,id);

var G__46338 = (i__46290 + (1));
i__46290 = G__46338;
continue;
} else {
var G__46339 = (i__46290 + (1));
i__46290 = G__46339;
continue;
}
} else {
...
return cljs.core.chunk_cons(cljs.core.chunk(b__46291),cljs$tools$reader$impl$errors$duplicate_keys_error_$_duplicates_$_iter__46288(cljs.core.chunk_rest(s__46289__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__46291),null);
}
} else {
var vec__46295 = cljs.core.first(s__46289__$2);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46295,(0),null);
var freq = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46295,(1),null);
if((freq > (1))){
return cljs.core.cons(id,cljs$tools$reader$impl$errors$duplicate_keys_error_$_duplicates_$_iter__46288(cljs.core.rest(s__46289__$2)));
} else {
var G__46341 = cljs.core.rest(s__46289__$2);
s__46289__$1 = G__46341;
continue;
}
}
} else {
