...
var G__88017_88043 = hickory.core.as_hiccup;
var G__88018_88044 = "object";
var G__88019_88045 = ((function (G__88017_88043,G__88018_88044){
return (function (this$){
var pred__88020 = cljs.core._EQ_;
var expr__88021 = (this$["nodeType"]);
if(cljs.core.truth_((pred__88020.cljs$core$IFn$_invoke$arity$2 ? pred__88020.cljs$core$IFn$_invoke$arity$2(hickory.core.Attribute,expr__88021) : pred__88020.call(null,hickory.core.Attribute,expr__88021)))){
...
if(cljs.core.truth_((pred__88020.cljs$core$IFn$_invoke$arity$2 ? pred__88020.cljs$core$IFn$_invoke$arity$2(hickory.core.Comment,expr__88021) : pred__88020.call(null,hickory.core.Comment,expr__88021)))){
return ["<!--",cljs.core.str.cljs$core$IFn$_invoke$arity$1((this$["data"])),"-->"].join('');
} else {
if(cljs.core.truth_((pred__88020.cljs$core$IFn$_invoke$arity$2 ? pred__88020.cljs$core$IFn$_invoke$arity$2(hickory.core.Document,expr__88021) : pred__88020.call(null,hickory.core.Document,expr__88021)))){
return cljs.core.map.cljs$core$IFn$_invoke$arity$2(hickory.core.as_hiccup,(this$["childNodes"]));
} else {
if(cljs.core.truth_((pred__88020.cljs$core$IFn$_invoke$arity$2 ? pred__88020.cljs$core$IFn$_invoke$arity$2(hickory.core.DocumentType,expr__88021) : pred__88020.call(null,hickory.core.DocumentType,expr__88021)))){
return hickory.core.format_doctype(this$);
} else {
if(cljs.core.truth_((pred__88020.cljs$core$IFn$_invoke$arity$2 ? pred__88020.cljs$core$IFn$_invoke$arity$2(hickory.core.Element,expr__88021) : pred__88020.call(null,hickory.core.Element,expr__88021)))){
var tag = hickory.utils.lower_case_keyword((this$["tagName"]));
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,cljs.core.concat.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [tag,cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,cljs.core.map.cljs$core$IFn$_invoke$arity$2(hickory.core.as_hiccup,(this$["attributes"])))], null),(cljs.core.truth_((hickory.utils.unescapable_content.cljs$core$IFn$_invoke$arity$1 ? hickory.utils.unescapable_content.cljs$core$IFn$_invoke$arity$1(tag) : hickory.utils.unescapable_content.call(null,tag)))?cljs.core.map.cljs$core$IFn$_invoke$arity$2(((function (tag,pred__88020,expr__88021,G__88017_88043,G__88018_88044){
return (function (p1__88016_SHARP_){
return (p1__88016_SHARP_["wholeText"]);
});})(tag,pred__88020,expr__88021,G__88017_88043,G__88018_88044))
,(this$["childNodes"])):cljs.core.map.cljs$core$IFn$_invoke$arity$2(hickory.core.as_hiccup,(this$["childNodes"])))));
} else {
if(cljs.core.truth_((pred__88020.cljs$core$IFn$_invoke$arity$2 ? pred__88020.cljs$core$IFn$_invoke$arity$2(hickory.core.Text,expr__88021) : pred__88020.call(null,hickory.core.Text,expr__88021)))){
return hickory.utils.html_escape((this$["wholeText"]));
} else {
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(expr__88021)].join('')));
}
}
}
}
...
});})(G__88017_88043,G__88018_88044))
;
goog.object.set(G__88017_88043,G__88018_88044,G__88019_88045);
goog.object.set(hickory.core.HickoryRepresentable,"object",true);

var G__88024_88048 = hickory.core.as_hickory;
var G__88025_88049 = "object";
var G__88026_88050 = ((function (G__88024_88048,G__88025_88049){
return (function (this$){
var pred__88027 = cljs.core._EQ_;
var expr__88028 = (this$["nodeType"]);
if(cljs.core.truth_((pred__88027.cljs$core$IFn$_invoke$arity$2 ? pred__88027.cljs$core$IFn$_invoke$arity$2(hickory.core.Attribute,expr__88028) : pred__88027.call(null,hickory.core.Attribute,expr__88028)))){
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [hickory.utils.lower_case_keyword((this$["name"])),(this$["value"])], null);
} else {
if(cljs.core.truth_((pred__88027.cljs$core$IFn$_invoke$arity$2 ? pred__88027.cljs$core$IFn$_invoke$arity$2(hickory.core.Comment,expr__88028) : pred__88027.call(null,hickory.core.Comment,expr__88028)))){
...
if(cljs.core.truth_((pred__88027.cljs$core$IFn$_invoke$arity$2 ? pred__88027.cljs$core$IFn$_invoke$arity$2(hickory.core.Document,expr__88028) : pred__88027.call(null,hickory.core.Document,expr__88028)))){
...
if(cljs.core.truth_((pred__88027.cljs$core$IFn$_invoke$arity$2 ? pred__88027.cljs$core$IFn$_invoke$arity$2(hickory.core.DocumentType,expr__88028) : pred__88027.call(null,hickory.core.DocumentType,expr__88028)))){
...
if(cljs.core.truth_((pred__88027.cljs$core$IFn$_invoke$arity$2 ? pred__88027.cljs$core$IFn$_invoke$arity$2(hickory.core.Element,expr__88028) : pred__88027.call(null,hickory.core.Element,expr__88028)))){
...
if(cljs.core.truth_((pred__88027.cljs$core$IFn$_invoke$arity$2 ? pred__88027.cljs$core$IFn$_invoke$arity$2(hickory.core.Text,expr__88028) : pred__88027.call(null,hickory.core.Text,expr__88028)))){
return (this$["wholeText"]);
} else {
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(expr__88028)].join('')));
}
}
}
}
...
});})(G__88024_88048,G__88025_88049))
;
goog.object.set(G__88024_88048,G__88025_88049,G__88026_88050);
hickory.core.extract_doctype = (function hickory$core$extract_doctype(s){
var temp__5735__auto__ = cljs.core.second((function (){var or__4131__auto__ = cljs.core.re_find(/<!DOCTYPE ([^>]*)>/,s);
...
var temp__5735__auto___88052 = cljs.core.first((doc["head"]["childNodes"]));
if(cljs.core.truth_(temp__5735__auto___88052)){
var title_el_88054 = temp__5735__auto___88052;
if(cljs.core.empty_QMARK_((title_el_88054["text"]))){
hickory.core.remove_el(title_el_88054);
} else {
}
} else {
}
