 ...
 *   lookup refs.
 */
com.fulcrologic.fulcro.algorithms.denormalize.follow_ref = (function com$fulcrologic$fulcro$algorithms$denormalize$follow_ref(state_map,p__72036){
var vec__72037 = p__72036;
var table = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__72037,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__72037,(1),null);
var ref = vec__72037;
 ...
 */
com.fulcrologic.fulcro.algorithms.denormalize.ref_key = (function com$fulcrologic$fulcro$algorithms$denormalize$ref_key(p__72044){
var vec__72046 = p__72044;
var table = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__72046,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__72046,(1),null);
var ref = vec__72046;
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Symbol(null,"_","_",-1201019570,null),id)){
return table;
} else {
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (n,p__72050){
var map__72051 = p__72050;
...
var key = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__72051__$1,new cljs.core.Keyword(null,"key","key",-1516042587));
...
var temp__5733__auto__ = (function (){var and__4120__auto__ = cljs.core.coll_QMARK_(entity);
...
com.fulcrologic.fulcro.algorithms.denormalize.add_join_BANG_ = (function com$fulcrologic$fulcro$algorithms$denormalize$add_join_BANG_(n,p__72053,entity,state_map,parent_node,idents_seen){
var map__72054 = p__72053;
var map__72054__$1 = (((((!((map__72054 == null))))?(((((map__72054.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__72054.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__72054):map__72054);
var join_node = map__72054__$1;
var query = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__72054__$1,new cljs.core.Keyword(null,"query","query",-1288509510));
var key = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__72054__$1,new cljs.core.Keyword(null,"key","key",-1516042587));
...
});})(link_join_QMARK_,v,key__$1,is_ref_QMARK_,join_entity,to_many_QMARK_,depth_based_QMARK_,recursive_QMARK_,stop_recursion_QMARK_,parent_node__$1,target_node,idents_seen__$1,map__72054,map__72054__$1,join_node,query,key))
),join_entity));
} else {
...
var join_node_index = cljs.core.reduce.cljs$core$IFn$_invoke$arity$3(((function (link_join_QMARK_,v,key__$1,is_ref_QMARK_,join_entity,to_many_QMARK_,depth_based_QMARK_,recursive_QMARK_,stop_recursion_QMARK_,parent_node__$1,target_node,idents_seen__$1,map__72054,map__72054__$1,join_node,query,key){
...
com.fulcrologic.fulcro.algorithms.denormalize.add_union_BANG_ = (function com$fulcrologic$fulcro$algorithms$denormalize$add_union_BANG_(n,p__72060,entity,state_map,idents_seen){
var map__72061 = p__72060;
var map__72061__$1 = (((((!((map__72061 == null))))?(((((map__72061.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__72061.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__72061):map__72061);
var join_node = map__72061__$1;
var key = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__72061__$1,new cljs.core.Keyword(null,"key","key",-1516042587));
var link_join_QMARK_ = com.fulcrologic.fulcro.algorithms.denormalize.lookup_ref_QMARK_(key);
...
var union_key__GT_query = cljs.core.reduce.cljs$core$IFn$_invoke$arity$3(((function (link_join_QMARK_,v,union_node,map__72061,map__72061__$1,join_node,key){
return (function (result,p__72063){
var map__72064 = p__72063;
var map__72064__$1 = (((((!((map__72064 == null))))?(((((map__72064.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__72064.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__72064):map__72064);
var node = map__72064__$1;
var union_key = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__72064__$1,new cljs.core.Keyword(null,"union-key","union-key",1529707234));
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(result,union_key,node);
});})(link_join_QMARK_,v,union_node,map__72061,map__72061__$1,join_node,key))
...
if(to_many_QMARK_){
return cljs.core.assoc_BANG_.cljs$core$IFn$_invoke$arity$3(n,key,cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentVector.EMPTY,cljs.core.keep.cljs$core$IFn$_invoke$arity$1(((function (link_join_QMARK_,v,union_node,union_key__GT_query,is_ref_QMARK_,to_many_QMARK_,map__72061,map__72061__$1,join_node,key){
return (function (lookup_ref){
var temp__5733__auto__ = (function (){var and__4120__auto__ = com.fulcrologic.fulcro.algorithms.denormalize.lookup_ref_QMARK_(lookup_ref);
if(and__4120__auto__){
...
var vec__72066 = lookup_ref;
var table = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__72066,(0),null);
...
});})(link_join_QMARK_,v,union_node,union_key__GT_query,is_ref_QMARK_,to_many_QMARK_,map__72061,map__72061__$1,join_node,key))
),v));
} else {
if(is_ref_QMARK_){
...
if(cljs.core.truth_(temp__5733__auto__)){
var e = temp__5733__auto__;
var temp__5733__auto____$1 = (function (){var G__72069 = cljs.core.first(v);
return (union_key__GT_query.cljs$core$IFn$_invoke$arity$1 ? union_key__GT_query.cljs$core$IFn$_invoke$arity$1(G__72069) : union_key__GT_query.call(null,G__72069));
})();
if(cljs.core.truth_(temp__5733__auto____$1)){
var target_ast_node = temp__5733__auto____$1;
 ...
 */
com.fulcrologic.fulcro.algorithms.denormalize.denormalize = (function com$fulcrologic$fulcro$algorithms$denormalize$denormalize(p__72070,current_entity,state_map,idents_seen){
...
var top_node = map__72071__$1;
var type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__72071__$1,new cljs.core.Keyword(null,"type","type",1174270348));
var children = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__72071__$1,new cljs.core.Keyword(null,"children","children",-940561982));
...
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Symbol(null,"*","*",345799209,null),(function (){var G__72073 = nil_nodes;
var G__72073__$1 = (((G__72073 == null))?null:cljs.core.first(G__72073));
if((G__72073__$1 == null)){
return null;
} else {
return new cljs.core.Keyword(null,"key","key",-1516042587).cljs$core$IFn$_invoke$arity$1(G__72073__$1);
}
})());
} else {
return and__4120__auto__;
...
var G__72074 = result_node__$1;
var G__72074__$1 = (((G__72074 == null))?null:cljs.core.persistent_BANG_(G__72074));
if((G__72074__$1 == null)){
return null;
} else {
return com.fulcrologic.fulcro.algorithms.denormalize.with_time(G__72074__$1,com.fulcrologic.fulcro.algorithms.denormalize._STAR_denormalize_time_STAR_);
}
});
/**
...
var G__72075 = com.fulcrologic.fulcro.algorithms.denormalize.denormalize(ast,starting_entity,state_map,cljs.core.PersistentArrayMap.EMPTY);
if((G__72075 == null)){
return null;
} else {
return com.fulcrologic.fulcro.algorithms.denormalize.with_time(G__72075,com.fulcrologic.fulcro.algorithms.denormalize._STAR_denormalize_time_STAR_);
}
});
/**
...
var G__72076 = props;
var G__72076__$1 = (((G__72076 == null))?null:cljs.core.meta(G__72076));
if((G__72076__$1 == null)){
return null;
} else {
return new cljs.core.Keyword("com.fulcrologic.fulcro.algorithms.denormalize","time","com.fulcrologic.fulcro.algorithms.denormalize/time",-375164969).cljs$core$IFn$_invoke$arity$1(G__72076__$1);
}
});
