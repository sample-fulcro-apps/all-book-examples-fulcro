...
if((!((ident == null)))){
return cljs.core.vary_meta.cljs$core$IFn$_invoke$arity$4((function (){var G__73084 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(query,cljs.core.first(ident));
var G__73085 = data__$1;
var G__73086 = refs;
var G__73087 = union_seen;
var G__73088 = transform;
return (com.fulcrologic.fulcro.algorithms.normalize.normalize_STAR_.cljs$core$IFn$_invoke$arity$5 ? com.fulcrologic.fulcro.algorithms.normalize.normalize_STAR_.cljs$core$IFn$_invoke$arity$5(G__73084,G__73085,G__73086,G__73087,G__73088) : com.fulcrologic.fulcro.algorithms.normalize.normalize_STAR_.call(null,G__73084,G__73085,G__73086,G__73087,G__73088));
...
var vec__73102 = com.fulcrologic.fulcro.algorithms.do_not_use.join_entry(expr);
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__73102,(0),null);
var sel = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__73102,(1),null);
...
var G__73120 = cljs.core.next(q);
var G__73121 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(ret,k,i);
q = G__73120;
ret = G__73121;
continue;
} else {
var G__73122 = cljs.core.next(q);
var G__73123 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(ret,k,x);
q = G__73122;
ret = G__73123;
continue;
}
...
var xs = cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentVector.EMPTY,cljs.core.map.cljs$core$IFn$_invoke$arity$1(((function (q,ret,vec__73102,k,sel,recursive_QMARK_,union_entry,sel__$1,class$,v,expr,data__$1){
return (function (p1__73082_SHARP_){
return (com.fulcrologic.fulcro.algorithms.normalize.normalize_STAR_.cljs$core$IFn$_invoke$arity$5 ? com.fulcrologic.fulcro.algorithms.normalize.normalize_STAR_.cljs$core$IFn$_invoke$arity$5(sel__$1,p1__73082_SHARP_,refs,union_entry,transform) : com.fulcrologic.fulcro.algorithms.normalize.normalize_STAR_.call(null,sel__$1,p1__73082_SHARP_,refs,union_entry,transform));
});})(q,ret,vec__73102,k,sel,recursive_QMARK_,union_entry,sel__$1,class$,v,expr,data__$1))
),v);
if((!((((class$ == null)) || ((!(com.fulcrologic.fulcro.components.has_ident_QMARK_(class$)))))))){
var is = cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentVector.EMPTY,cljs.core.map.cljs$core$IFn$_invoke$arity$1(((function (q,ret,xs,vec__73102,k,sel,recursive_QMARK_,union_entry,sel__$1,class$,v,expr,data__$1){
return (function (p1__73083_SHARP_){
return com.fulcrologic.fulcro.components.get_ident.cljs$core$IFn$_invoke$arity$2(class$,p1__73083_SHARP_);
});})(q,ret,xs,vec__73102,k,sel,recursive_QMARK_,union_entry,sel__$1,class$,v,expr,data__$1))
),xs);
if(cljs.core.vector_QMARK_(sel__$1)){
if(cljs.core.empty_QMARK_(is)){
} else {
cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$2(refs,((function (q,ret,is,xs,vec__73102,k,sel,recursive_QMARK_,union_entry,sel__$1,class$,v,expr,data__$1){
return (function (refs__$1){
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3(((function (q,ret,is,xs,vec__73102,k,sel,recursive_QMARK_,union_entry,sel__$1,class$,v,expr,data__$1){
return (function (m,p__73106){
var vec__73107 = p__73106;
var i = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__73107,(0),null);
var x = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__73107,(1),null);
return cljs.core.update_in.cljs$core$IFn$_invoke$arity$4(m,i,cljs.core.merge,x);
});})(q,ret,is,xs,vec__73102,k,sel,recursive_QMARK_,union_entry,sel__$1,class$,v,expr,data__$1))
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3(((function (q,ret,is,xs,vec__73102,k,sel,recursive_QMARK_,union_entry,sel__$1,class$,v,expr,data__$1){
return (function (ret__$1,p__73110){
var vec__73111 = p__73110;
var i = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__73111,(0),null);
var x = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__73111,(1),null);
...
var G__73125 = cljs.core.next(q);
var G__73126 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(ret,k,is);
q = G__73125;
ret = G__73126;
continue;
} else {
var G__73127 = cljs.core.next(q);
var G__73128 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(ret,k,xs);
q = G__73127;
ret = G__73128;
continue;
}
...
if((v == null)){
var G__73129 = cljs.core.next(q);
var G__73130 = ret;
q = G__73129;
ret = G__73130;
continue;
} else {
var G__73131 = cljs.core.next(q);
var G__73132 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(ret,k,v);
q = G__73131;
ret = G__73132;
continue;
...
var v = cljs.core.get.cljs$core$IFn$_invoke$arity$2(data__$1,k);
if((v == null)){
var G__73134 = cljs.core.next(q);
var G__73135 = ret;
q = G__73134;
ret = G__73135;
continue;
} else {
var G__73136 = cljs.core.next(q);
var G__73137 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(ret,k,v);
q = G__73136;
ret = G__73137;
continue;
}
