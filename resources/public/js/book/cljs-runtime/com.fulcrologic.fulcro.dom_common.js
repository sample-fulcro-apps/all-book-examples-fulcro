...
return (function (p1__78620_SHARP_){
return cljs.core.re_matches(/^#.*/,p1__78620_SHARP_);
});})(tokens))
,tokens));
var classes = cljs.core.filter.cljs$core$IFn$_invoke$arity$2(((function (tokens,id){
return (function (p1__78621_SHARP_){
return cljs.core.re_matches(/^\..*/,p1__78621_SHARP_);
});})(tokens,id))
,tokens);
...
var G__78625 = new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"classes","classes",2037804510),cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,cljs.core.keep.cljs$core$IFn$_invoke$arity$2(com.fulcrologic.fulcro.dom_common.remove_separators,classes))], null);
if(cljs.core.truth_(sanitized_id)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__78625,new cljs.core.Keyword(null,"id","id",-1388402092),sanitized_id);
} else {
return G__78625;
}
} else {
...
var map__78631 = com.fulcrologic.fulcro.dom_common.parse(kw);
var map__78631__$1 = (((((!((map__78631 == null))))?(((((map__78631.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__78631.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__78631):map__78631);
var classes = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__78631__$1,new cljs.core.Keyword(null,"classes","classes",2037804510),cljs.core.PersistentVector.EMPTY);
var id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__78631__$1,new cljs.core.Keyword(null,"id","id",-1388402092));
...
var G__78637_78675 = props__$1;
var G__78638_78676 = "className";
var G__78639_78677 = com.fulcrologic.fulcro.dom_common.combined_classes(classes,existing_classes);
goog.object.set(G__78637_78675,G__78638_78676,G__78639_78677);
} else {
}
...
var G__78640 = (function (){var or__4131__auto__ = props;
...
var G__78640__$1 = ((cljs.core.seq(classes))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__78640,new cljs.core.Keyword(null,"className","className",-1983287057),com.fulcrologic.fulcro.dom_common.combined_classes(classes,existing_classes)):G__78640);
if(cljs.core.truth_(id)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__78640__$1,new cljs.core.Keyword(null,"id","id",-1388402092),id);
} else {
return G__78640__$1;
}
}
