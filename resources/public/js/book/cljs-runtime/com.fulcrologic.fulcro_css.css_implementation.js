...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(com.fulcrologic.fulcro_css.css_implementation.cssify(com.fulcrologic.fulcro_css.css_implementation.fqname(comp_class))),"__",cljs.core.name(nm)].join('');
});
...
return cljs.core.boolean$((function (){var G__75971 = x;
var G__75971__$1 = (((G__75971 == null))?null:com.fulcrologic.fulcro.components.component_options(G__75971));
if((G__75971__$1 == null)){
return null;
} else {
return new cljs.core.Keyword(null,"css","css",1135045163).cljs$core$IFn$_invoke$arity$1(G__75971__$1);
}
})());
});
/**
...
var temp__5733__auto__ = (function (){var G__75974 = component;
var G__75974__$1 = (((G__75974 == null))?null:com.fulcrologic.fulcro.components.component_options(G__75974));
if((G__75974__$1 == null)){
return null;
} else {
return new cljs.core.Keyword(null,"css","css",1135045163).cljs$core$IFn$_invoke$arity$1(G__75974__$1);
}
})();
...
var temp__5733__auto__ = (function (){var G__75977 = component;
var G__75977__$1 = (((G__75977 == null))?null:com.fulcrologic.fulcro.components.component_options(G__75977));
if((G__75977__$1 == null)){
return null;
} else {
return new cljs.core.Keyword(null,"css-global","css-global",-943240719).cljs$core$IFn$_invoke$arity$1(G__75977__$1);
}
})();
if(cljs.core.truth_(temp__5733__auto__)){
var entry = temp__5733__auto__;
...
var vec__75984 = cljs.core.re_matches(/(\.|\$|&\.|&\$).*/,nm);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__75984,(0),null);
var prefix = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__75984,(1),null);
return prefix;
});
/**
...
var includes = (function (){var G__75987 = component;
var G__75987__$1 = (((G__75987 == null))?null:com.fulcrologic.fulcro.components.component_options(G__75987));
if((G__75987__$1 == null)){
return null;
} else {
return new cljs.core.Keyword(null,"css-include","css-include",559023012).cljs$core$IFn$_invoke$arity$1(G__75987__$1);
}
})();
...
return (function (p1__75988_SHARP_,p2__75989_SHARP_){
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(p1__75988_SHARP_,(com.fulcrologic.fulcro_css.css_implementation.get_nested_includes.cljs$core$IFn$_invoke$arity$1 ? com.fulcrologic.fulcro_css.css_implementation.get_nested_includes.cljs$core$IFn$_invoke$arity$1(p2__75989_SHARP_) : com.fulcrologic.fulcro_css.css_implementation.get_nested_includes.call(null,p2__75989_SHARP_)));
});})(direct_children))
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__75995)].join('')));
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__75998)].join('')));
...
return (function (p1__76000_SHARP_){
return cljs.core.re_matches(/[.$].*/,p1__76000_SHARP_);
});})(val))
...
var local_classnames = cljs.core.zipmap(cljs.core.map.cljs$core$IFn$_invoke$arity$2(com.fulcrologic.fulcro_css.css_implementation.remove_prefix_kw,local_class_keys),cljs.core.map.cljs$core$IFn$_invoke$arity$2(((function (local_class_keys,global_class_keys){
return (function (p1__76005_SHARP_){
return com.fulcrologic.fulcro_css.css_implementation.kw__GT_localized_classname(comp,p1__76005_SHARP_);
