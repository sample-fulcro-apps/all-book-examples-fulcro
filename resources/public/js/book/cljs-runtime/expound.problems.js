...
while(true){
var vec__67350 = in$;
var seq__67351 = cljs.core.seq(vec__67350);
var first__67352 = cljs.core.first(seq__67351);
var seq__67351__$1 = cljs.core.next(seq__67351);
var k = first__67352;
var rst = seq__67351__$1;
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(displayed_form,new cljs.core.Keyword(null,"key","key",-1516042587).cljs$core$IFn$_invoke$arity$1(k)),(function (){var G__67354 = show_valid_values_QMARK_;
var G__67355 = new cljs.core.Keyword(null,"key","key",-1516042587).cljs$core$IFn$_invoke$arity$1(k);
var G__67356 = rst__$1;
return (expound.problems.summary_form.cljs$core$IFn$_invoke$arity$3 ? expound.problems.summary_form.cljs$core$IFn$_invoke$arity$3(G__67354,G__67355,G__67356) : expound.problems.summary_form.call(null,G__67354,G__67355,G__67356));
})(),new cljs.core.Keyword("expound.problems","irrelevant","expound.problems/irrelevant",2090226124));
} else {
if(((cljs.core.map_QMARK_(form)) && (expound.paths.kvps_QMARK_(k)))){
var G__67472 = show_valid_values_QMARK_;
var G__67473 = cljs.core.nth.cljs$core$IFn$_invoke$arity$2(cljs.core.seq(form),new cljs.core.Keyword(null,"idx","idx",1053688473).cljs$core$IFn$_invoke$arity$1(k));
var G__67474 = rst__$1;
show_valid_values_QMARK_ = G__67472;
form = G__67473;
in$ = G__67474;
continue;
} else {
if(cljs.core.associative_QMARK_(form)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(displayed_form,k,(function (){var G__67364 = show_valid_values_QMARK_;
var G__67365 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(form,k);
var G__67366 = rst__$1;
return (expound.problems.summary_form.cljs$core$IFn$_invoke$arity$3 ? expound.problems.summary_form.cljs$core$IFn$_invoke$arity$3(G__67364,G__67365,G__67366) : expound.problems.summary_form.call(null,G__67364,G__67365,G__67366));
})());
} else {
if(((cljs.core.int_QMARK_(k)) && (cljs.core.seq_QMARK_(form)))){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.list,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.vec(displayed_form),k,(function (){var G__67374 = show_valid_values_QMARK_;
var G__67379 = cljs.core.nth.cljs$core$IFn$_invoke$arity$2(form,k);
var G__67380 = rst__$1;
return (expound.problems.summary_form.cljs$core$IFn$_invoke$arity$3 ? expound.problems.summary_form.cljs$core$IFn$_invoke$arity$3(G__67374,G__67379,G__67380) : expound.problems.summary_form.call(null,G__67374,G__67379,G__67380));
})()));
} else {
if(((cljs.core.int_QMARK_(k)) && (cljs.core.set_QMARK_(form)))){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentHashSet.EMPTY,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.vec(displayed_form),k,(function (){var G__67386 = show_valid_values_QMARK_;
var G__67387 = cljs.core.nth.cljs$core$IFn$_invoke$arity$2(cljs.core.seq(form),k);
var G__67388 = rst__$1;
return (expound.problems.summary_form.cljs$core$IFn$_invoke$arity$3 ? expound.problems.summary_form.cljs$core$IFn$_invoke$arity$3(G__67386,G__67387,G__67388) : expound.problems.summary_form.call(null,G__67386,G__67387,G__67388));
})()));
} else {
if(((cljs.core.int_QMARK_(k)) && (cljs.core.list_QMARK_(form)))){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.List.EMPTY,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.vec(displayed_form),k,(function (){var G__67389 = show_valid_values_QMARK_;
var G__67390 = cljs.core.nth.cljs$core$IFn$_invoke$arity$2(cljs.core.seq(form),k);
var G__67391 = rst__$1;
return (expound.problems.summary_form.cljs$core$IFn$_invoke$arity$3 ? expound.problems.summary_form.cljs$core$IFn$_invoke$arity$3(G__67389,G__67390,G__67391) : expound.problems.summary_form.call(null,G__67389,G__67390,G__67391));
})()));
} else {
...
var max_width = cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.max,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__67395_SHARP_){
return cljs.core.count(cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__67395_SHARP_));
...
var G__67408 = cljs.core.first(new cljs.core.Keyword(null,"path","path",-188191168).cljs$core$IFn$_invoke$arity$1(problem));
var fexpr__67407 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"ret","ret",-468222814),null], null), null);
return (fexpr__67407.cljs$core$IFn$_invoke$arity$1 ? fexpr__67407.cljs$core$IFn$_invoke$arity$1(G__67408) : fexpr__67407.call(null,G__67408));
}
...
var map__67434 = problem;
var map__67434__$1 = (((((!((map__67434 == null))))?(((((map__67434.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__67434.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__67434):map__67434);
var form = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__67434__$1,new cljs.core.Keyword("expound","form","expound/form",-264680632));
var in$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__67434__$1,new cljs.core.Keyword("expound","in","expound/in",-1900412298));
var map__67435 = opts;
...
var show_valid_values_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__67435__$1,new cljs.core.Keyword(null,"show-valid-values?","show-valid-values?",-587258094),false);
...
var s = (function (){var _STAR_print_namespace_maps_STAR__orig_val__67448 = cljs.core._STAR_print_namespace_maps_STAR_;
var _STAR_print_namespace_maps_STAR__temp_val__67449 = false;
cljs.core._STAR_print_namespace_maps_STAR_ = _STAR_print_namespace_maps_STAR__temp_val__67449;
...
}finally {cljs.core._STAR_print_namespace_maps_STAR_ = _STAR_print_namespace_maps_STAR__orig_val__67448;
}})();
var vec__67439 = cljs.core.re_find(regex,s);
...
var line = first__67441;
var first__67441__$1 = cljs.core.first(seq__67440__$1);
var seq__67440__$2 = cljs.core.next(seq__67440__$1);
var prefix = first__67441__$1;
var _more = seq__67440__$2;
...
var problems = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__67460__$1,new cljs.core.Keyword("cljs.spec.alpha","problems","cljs.spec.alpha/problems",447400814));
var value = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__67460__$1,new cljs.core.Keyword("cljs.spec.alpha","value","cljs.spec.alpha/value",1974786274));
var args = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__67460__$1,new cljs.core.Keyword("cljs.spec.alpha","args","cljs.spec.alpha/args",1870769783));
var ret = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__67460__$1,new cljs.core.Keyword("cljs.spec.alpha","ret","cljs.spec.alpha/ret",1165997503));
var fn = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__67460__$1,new cljs.core.Keyword("cljs.spec.alpha","fn","cljs.spec.alpha/fn",408600443));
var failure = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__67460__$1,new cljs.core.Keyword("cljs.spec.alpha","failure","cljs.spec.alpha/failure",188258592));
var spec = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__67460__$1,new cljs.core.Keyword("cljs.spec.alpha","spec","cljs.spec.alpha/spec",1947137578));
...
var problems_SINGLEQUOTE_ = cljs.core.map.cljs$core$IFn$_invoke$arity$2(cljs.core.comp.cljs$core$IFn$_invoke$arity$variadic(cljs.core.partial.cljs$core$IFn$_invoke$arity$2(expound.problems.adjust_in,form),cljs.core.partial.cljs$core$IFn$_invoke$arity$2(expound.problems.adjust_path,failure),cljs.core.partial.cljs$core$IFn$_invoke$arity$2(expound.problems.add_spec,spec),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([cljs.core.partial.cljs$core$IFn$_invoke$arity$2(expound.problems.fix_via,spec),((function (map__67460,map__67460__$1,problems,value,args,ret,fn,failure,spec,caller,form){
return (function (p1__67455_SHARP_){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(p1__67455_SHARP_,new cljs.core.Keyword("expound","form","expound/form",-264680632),form);
});})(map__67460,map__67460__$1,problems,value,args,ret,fn,failure,spec,caller,form))
,((function (map__67460,map__67460__$1,problems,value,args,ret,fn,failure,spec,caller,form){
return (function (p1__67457_SHARP_){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(p1__67457_SHARP_,new cljs.core.Keyword("expound.spec.problem","type","expound.spec.problem/type",-862044659),expound.problems.ptype(failure,p1__67457_SHARP_));
});})(map__67460,map__67460__$1,problems,value,args,ret,fn,failure,spec,caller,form))
], 0)),problems);
